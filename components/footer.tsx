...
const navigation = [
  ...
  {
    name: 'LinkedIn',
    href: 'https://www.linkedin.com/in/sadmankibria',
    icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
  ...
  {
    name: 'GitHub',
    href: 'https://github.com/SadmanKibria',
    icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
      <svg fill='currentColor' viewBox='0 0 24 24' {...props}>
        <path
          fillRule='evenodd'
  ...
  {
    name: 'YouTube',
    href: 'https://www.youtube.com/@SadmanKibria',
    icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
      <svg fill='currentColor' viewBox='0 0 24 24' {...props}>
        <path
          fillRule='evenodd'
        ...
        <div className='md:flex md:items-center md:justify-between'>
          ...
          <div className='mt-8 md:order-1 md:mt-0'>
            <p className='text-center text-xs leading-5 text-muted-foreground'>
              Created by Sadman Kibria - {''}
              <Link href='mailto:sadmankibria1@gmail.com' className='font-bold'>
                sadmankibria1@gmail.com.
              </Link>
            </p>
          </div>
        </div>
